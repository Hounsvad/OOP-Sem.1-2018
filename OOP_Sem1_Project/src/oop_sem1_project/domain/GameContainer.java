...
public class GameContainer {
    ...
    public void inititalize(String playerName) {
        ...
        Room hallway = new Room("Hallway", new int[]{0, 0}, "Hallway", "This is a hallway adjacent to the mainhall", 1, false);
        hallway.addMessage(0, "As you walk along the empty hallway, the smell of burnt electronics gets stronger.");
        ...
        Room robtek = new Room("Rob-tek", new int[]{0, 0}, "RobTek", "This is the room, the robottechnology enginneers reside in", 2, true);
        robtek.addMessage(0, "There is honestly no reason to ever be here");
        ...
        Room chemlab = new Room("Chem-lab", new int[]{0, 0}, "ChemLab", "A Chemical Laboratory", 4, true);
        chemlab.addMessage(0, "You walk up to the door of the Chemical lab, a sign on it says: \n \"Stay out, experiment in progress\"");
        ...
        Room workshop = new Room("Workshop", new int[]{0, 0}, "Workshop", "A Workshop for mechanical engineering", 6, true);
        workshop.addMessage(0, "You enter the workshop \n The air is filled with sawdust \n There is nothing to see here.");
        ...
        Room u55 = new Room("U55", new int[]{0, 0}, "U55", "This is one of the lecturehall of the university", 8, true);
        u55.addMessage(0, "Someone is giving a lecture right now, you decide to stay and listen for a while \n \" ...og som i har læst i e-tivitet 4... \" \n You decide not to listen any more and decide to head out of the room.");
