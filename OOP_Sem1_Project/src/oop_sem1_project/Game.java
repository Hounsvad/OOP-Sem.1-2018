...
public class Game {
    ...
    private void createRooms() {
        ...
        hall = new Room("in the main hall", 1, new String[]{"You notice a \"Safety Point\" in the corner. You should probably check it out", "maybe the \"safety point\" has something useful",""}, "This text should never appear", "Who knows");
        hallway = new Room("in a hallway adjacent to the main hall", 2, new String[]{"As you walk along the empty hallway, you notice a smell of burnt robot", "The hallway appears to be empty", " "}, "This text should never appear", "Who knows");
        robtek = new Room("in the room where the robottechnology enginneers reside", 3, new String[]{"A burning smell enters your nose. In the corner of the room you see flames shooting out of a one-armed robot.\nOne of the engineers shouts: \"Someone please help! We are useless\"", "Even with the fire gone, it still smells here \nBetter move on", " "}, "There is honestly no reason to ever be here", "Who knows");
        lab = new Room("in a lab for the chemical enginneers", 4, new String[]{"One of the chemists, screams in agony while desperatly rubbing his hands into his left eye \n You have to help him", "The sign still says \"Stay out, experiment in progress\" \n They are hopefully wearing safety glasses now", " "}, "You walk up to the door of the Chemical lab, a sign on it says: \n \"Stay out, experiment in progress\"", "Who knows");
        workshop = new Room("at a workshop for the mechanical engineering students", 5, new String[]{"You notice blood dripping from one of the students arm. \n\"Tis but a scratch!\" he claims. \nYou should probably help him anyway", "The cleaning ladies are trying to get rid of all the blood on the floor \nYou dont want to bother them", " "}, "You enter the workshop \n The air is filled with sawdust \n There is nothing to see here.", "Who knows");
        u55 = new Room("at the lecture hall", 6, new String[]{"In the middle of all the commotion, you notice a student in the back, laying on the floor, clutching his chest", "Everyone seems to have calmed down already, some srudents are even sleeping", " "}, "Someone is giving a lecture right now, you decide to stay and listen for a while \n \" ...og som i har læst i e-tivitet 4... \" \n You instantly walk out of the room ", "Who knows");
